...
const propertiesToSeed = [
    ...
    },
    {
        ...
        gallery: genericGallery, description: 'Vị trí trung tâm, giao thông thuận tiện.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-02', 4000000)
    },
    {
        ...
        gallery: genericGallery, description: 'Khu dân cư yên tĩnh, an ninh tốt.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-03', 3800000)
    },
    {
        ...
        gallery: genericGallery, description: 'Giá cả hợp lý, phù hợp sinh viên.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-04', 2800000)
    },
    {
        ...
        gallery: genericGallery, description: 'Gần các trường đại học lớn, tiện ích đầy đủ.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-05', 6000000)
    },
    {
        ...
        gallery: genericGallery, description: 'Căn hộ cao cấp, nội thất hiện đại.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-06', 7600000)
    },
    {
        ...
        gallery: genericGallery, description: 'Vị trí trung tâm quận Ba Đình, gần Lăng Bác.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-07', 8500000)
    },
    {
        ...
        gallery: genericGallery, description: 'View Hồ Tây thoáng đãng, không khí trong lành.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-08', 9500000)
    },
    {
        ...
        gallery: genericGallery, description: 'Gần Ngã Tư Sở, thuận tiện đi lại.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-09', 4800000)
    },
    {
        ...
        gallery: genericGallery, description: 'Gần Times City, nhiều tiện ích xung quanh.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HN-10', 5200000)
    },
    ...Array.from({ length: 10 }, (_, i) => ({
        ...
        gallery: genericGallery, description: `Mô tả mẫu cho căn hộ ${11 + i}`, amenities: genericAmenities, availableRoomDetails: genericRoomDetails(`HN-${11 + i}`, 2500000 + i * 500000)
    })),
    ...
    // TP. Hồ Chí Minh (20)
    {
        ...
        gallery: genericGallery, description: 'Căn hộ sang trọng ngay trung tâm Sài Gòn.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HCM-01', 8000000)
    },
    {
        ...
        gallery: genericGallery, description: 'Khu đô thị hiện đại, gần Crescent Mall.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HCM-02', 6800000)
    },
    {
        ...
        gallery: genericGallery, description: 'Làng đại học, phù hợp cho sinh viên.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HCM-03', 4800000)
    },
    {
        ...
        gallery: genericGallery, description: 'Gần các trường đại học, giá tốt.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HCM-04', 2500000)
    },
    {
        ...
        gallery: genericGallery, description: 'Trung tâm thành phố, tiện nghi cao cấp.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HCM-05', 9000000)
    },
    {
        ...
        gallery: genericGallery, description: 'Khu vực sầm uất, gần sân bay.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('HCM-06', 4500000)
    },
    ...Array.from({ length: 14 }, (_, i) => ({
        ...
        gallery: genericGallery, description: `Mô tả mẫu cho căn hộ ${7 + i}`, amenities: genericAmenities, availableRoomDetails: genericRoomDetails(`HCM-${7 + i}`, 3000000 + i * 400000)
    })),
    ...
    // Đà Nẵng (10)
    {
        ...
        gallery: genericGallery, description: 'View sông Hàn, trung tâm thành phố.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('DN-01', 6500000)
    },
    {
        ...
        gallery: genericGallery, description: 'Gần biển Mỹ Khê, khu du lịch.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('DN-02', 7500000)
    },
    {
        ...
        gallery: genericGallery, description: 'Khu phố Tây, gần nhiều nhà hàng, quán bar.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('DN-03', 5500000)
    },
    {
        ...
        gallery: genericGallery, description: 'Trung tâm quận Thanh Khê, tiện ích đầy đủ.', amenities: genericAmenities, availableRoomDetails: genericRoomDetails('DN-04', 4200000)
    },
